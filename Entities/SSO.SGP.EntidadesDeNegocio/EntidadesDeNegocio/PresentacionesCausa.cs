...
namespace SSO.SGP.EntidadesDeNegocio
{
	...
	/// </summary>
	[MetadataTypeAttribute(typeof(PresentacionesCausaMetaData))]
	[Table("PresentacionesCausa")]
	public partial class PresentacionesCausa
	{
		#region Constructor
		public PresentacionesCausa()
		{
			// Prueba de codigo
		}
		#endregion
		...
		[Required(ErrorMessage = "Debe ingresar Recepcionada")]
		...
		[Required(ErrorMessage = "Debe ingresar RequiereCoMediador")]
		...
		[ForeignKey("OrganismoRecepciona")]
		public virtual OrganismosRef OrganismoRecepcionas { get; set; }
		#endregion

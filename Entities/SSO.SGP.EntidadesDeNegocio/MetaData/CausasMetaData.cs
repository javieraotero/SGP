...
namespace SSO.SGP.MetaData
{
	...
	/// </summary>
	public partial class CausasMetaData
	{
			#region Propiedades
			...
			[Display(Name = "UsuarioRecepciono")]
			...
			[Display(Name = "OrganismoRecepciono")]
			public int? OrganismoRecepciono { get; set; }

			[Display(Name = "QuiebraAbierta")]
			public bool? QuiebraAbierta { get; set; }

			[Display(Name = "QuiebraConcluida")]

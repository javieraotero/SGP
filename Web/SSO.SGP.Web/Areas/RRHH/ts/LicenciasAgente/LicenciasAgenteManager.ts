...
module LicenciasAgente.ts { 
    ...
    export class LicenciasAgenteManager {

        public ViewIndex: Index;
        public ViewCrear: Crear;
        public ViewConsulta: Consulta;
        public ViewLimitar: Limitar; 
        public ViewExcepcion: Excepcion;
        public ViewResumenOrganizacion: ResumenOrganizacion;
        public ViewSolicitar: Crear; 
        public ViewPendientesAprobar: Pendientes;
        public ViewPendientesTodos: PendientesTodos;
        public ViewSolicitarPorEnfermedad: Crear; 

        constructor() {
            // Constructor
        }

        public setResumenOrganizacion(v: ResumenOrganizacion) {
        ...
        public setPendientes(v: Pendientes) {
            var that = this;
        ...
        public setPendientesTodos(v: PendientesTodos) {
            var that = this;
        ...
        public setExcepcion(v: Excepcion) {
            var self = this;
        ...
        public setEditarSolicitud(v: Crear) {
            var that = this;
            var tiene_expediente = false;
            this.ViewSolicitar = v;
            const licenciaMedica = [8, 9, 10, 11, 12, 49, 46];
            ...
            v.FechaDesde.change(function (e) {
                const carpetaMedica = licenciaMedica.indexOf(parseInt(v.Licencia.valor())) >= 0;
        ...
        public setSolicitarPorEnfermedad(v: Crear) {
            var that = this;
            var tiene_expediente = false;
        ...
        public setCrear(v: Crear) {
            ...
            v.AgenteRRHH.setCallback(function (ui: any) {
        ...
        public setMiConsulta(v: Consulta) {
            var that = this;
            this.ViewConsulta = v;
            // Eventos de la vista
        ...
        public setConsultaMM(v: Consulta) {
            var that = this;
            this.ViewConsulta = v;
            // Eventos de la vista
        ...
        public confirmalicencia_dtAgentes(el): void {
            var self = this;
            this.ViewPendientesAprobar.selectRow_Licencia(el);
            var id = this.ViewPendientesAprobar.getData(0);
            var token = this.ViewPendientesAprobar.getData(10);
        ...
        public editarLicencia_dtAgentes(el): void {
            var self = this;
            this.ViewPendientesAprobar.selectRow_Licencia(el);
            const id = this.ViewPendientesAprobar.getData(0);
            const agente = this.ViewPendientesAprobar.getData(1);
            
            app.modal.cargar("Editar carpeta médica de " + agente, "/RRHH/LicenciasAgente/EditarSolicitud/" + id); 

        }

        public verSolicitud_dtAgentes(el): void {
            var self = this;
        ...
        public cancelarSolicitud_dtAgentes(el): void {
            var self = this;
            this.ViewPendientesAprobar.selectRow_Licencia(el);
            var id = this.ViewPendientesAprobar.getData(0);
            var token = this.ViewPendientesAprobar.getData(10);
        ...
        public aprobarsubrogancia_dtAgentes(el): void {
            var self = this;
            this.ViewPendientesAprobar.selectRow_Licencia(el);
            var id = this.ViewPendientesAprobar.getData(0);
            var token = this.ViewPendientesAprobar.getData(10);
        ...
        public desaprobarlicencia_dtAgentes(el):void {
            var self = this;
            this.ViewPendientesAprobar.selectRow_Licencia(el);
            var id = this.ViewPendientesAprobar.getData(0);
            var token = this.ViewPendientesAprobar.getData(10);
        ...
        public desaprobarsubrogancia_dtAgentes(el): void {
            var self = this;
            this.ViewPendientesAprobar.selectRow_Licencia(el);
            var id = this.ViewPendientesAprobar.getData(0);
            var token = this.ViewPendientesAprobar.getData(10);
        ...
        public ajaxSolicitar(v: IControlador, titulo: string, resultado?: ResultadoApp): JQueryDeferred {
            var that = this;
        ...
        public ajaxSolicitarPorEnfermedad(v: IControlador, titulo: string, resultado?: ResultadoApp): JQueryDeferred {
            var that = this;
            var view = that.ViewSolicitar;
            var df = $.Deferred();
            //v.form.validate();

...
(function (Agentes) {
    var ts;
    (function (ts) {
        var AgentesManager = (function () {
            function AgentesManager() {
                // Constructor
            }
            //--- Inicialización de la vista Index
            AgentesManager.prototype.setIndex = function (v) {
                var that = this;
                this.ViewIndex = v;
                // Eventos de la vista
            };
            AgentesManager.prototype.setIndexBonificaciones = function (v) {
                var that = this;
                this.ViewIndexBonificaciones = v;
            };
            AgentesManager.prototype.setCrearMovimientoCesida = function (v) {
                var that = this;
            ...
            AgentesManager.prototype.setBonificaciones = function (v) {
                var that = this;
            ...
            //--- Inicialización de la vista Index
            AgentesManager.prototype.setResumen = function (v) {
                var that = this;
                this.ViewResumen = v;
                // Eventos de la vista
            };
            //--- Inicialización de la vista Crear
            AgentesManager.prototype.setCrear = function (v) {
                var that = this;
                this.ViewCrear = v;
                // Eventos de la vista
            ...
            AgentesManager.prototype.setEditar = function (v) {
                var that = this;
                this.ViewEditar = v;
                // Eventos de la vista
                v.Cancelar.click(function (e) {
            ...
            AgentesManager.prototype.setEliminar = function (v) {
                var that = this;
                this.ViewEliminar = v;
                // Eventos de la vista
            };
            //--- Inicialización de la vista Detalle
            AgentesManager.prototype.setDetalle = function (v) {
                var that = this;
                this.ViewDetalle = v;
                // Eventos de la vista
            };
            //--- Función editar de Datatable Agentes
            AgentesManager.prototype.editar_dtAgentes = function () {
            ...
            //    //app.createTab("Editar", "Agentes/Editar/" + id, true, true, true);
            //}
            AgentesManager.prototype.ver_proveedor = function () {
                var id = this.ViewIndex.getData(0);
                var i = new ItemMenu();
                i.label = "Editar";
                i.close = true;
            ...
            //--- Función editar de Datatable Agentes
            AgentesManager.prototype.docencia_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
                var i = new ItemMenu();
                i.label = "Docencia";
                i.close = true;
            ...
            AgentesManager.prototype.adjuntos_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
            ...
            AgentesManager.prototype.certificado_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
            ...
            AgentesManager.prototype.imprimircaratula_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
            ...
            AgentesManager.prototype.eliminar_dtAgentes = function (id) {
            ...
            AgentesManager.prototype.nombramientos_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
                var descripcion = this.ViewIndex.getData(2);
                var i = new ItemMenu();
            ...
            AgentesManager.prototype.sustituciones_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
                var descripcion = this.ViewIndex.getData(2);
            ...
            AgentesManager.prototype.medidas_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
                var descripcion = this.ViewIndex.getData(2);
            ...
            AgentesManager.prototype.grupofamiliar_dtAgentes = function () {
                var id = this.ViewIndex.getData(0);
                var descripcion = this.ViewIndex.getData(2);
            ...
            AgentesManager.prototype.ajaxPost = function (v, titulo, resultado) {
                var that = this;
                var df = $.Deferred();
                v.form.validate();
                var success = false;
            ...
            AgentesManager.prototype.ajaxPostURL = function (url, data, titulo, res) {
                var that = this;
                var df = $.Deferred();
                var success = false;
                var retorno = 0;
            ...
            AgentesManager.prototype.eliminar = function (url, data, res) {
                var that = this;
                var df = $.Deferred();
            ...
            AgentesManager.prototype.daysInMonth = function (month, year) {
                return new Date(year, month, 0).getDate();
            };
            AgentesManager.prototype.getDaysInMonth = function (m, y) {
                return /8|3|5|10/.test(--m) ? 30 : m == 1 ? (!(y % 4) && y % 100) || !(y % 400) ? 29 : 28 : 31;
            };
            return AgentesManager;
        })();
        ts.AgentesManager = AgentesManager; //JS	

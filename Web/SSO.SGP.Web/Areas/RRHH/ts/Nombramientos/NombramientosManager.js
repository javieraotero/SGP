...
(function (Nombramientos) {
    var ts;
    (function (ts) {
        var NombramientosManager = (function () {
            function NombramientosManager() {
                // Constructor
            }
            //--- Inicialización de la vista Index
            NombramientosManager.prototype.setIndex = function (v) {
                var that = this;
                this.ViewIndex = v;
            ...
            NombramientosManager.prototype.setCrear = function (v) {
                var that = this;
                this.ViewCrear = v;
                // Eventos de la vista
                v.Cancelar.click(function (e) {
            ...
            NombramientosManager.prototype.setEditar = function (v) {
                var that = this;
                this.ViewEditar = v;
                // Eventos de la vista
                v.Cancelar.click(function (e) {
            ...
            NombramientosManager.prototype.ajaxPost = function (v, titulo, res) {
                var that = this;
                var df = $.Deferred();
                v.form.validate();
                var success = false;
            ...
            NombramientosManager.prototype.ajaxPostURL = function (url, data, titulo, res) {
                var that = this;
                var df = $.Deferred();
                var success = false;
                var retorno = 0;
            ...
            NombramientosManager.prototype.eliminar = function (url, data) {
                var that = this;
                var df = $.Deferred();
            ...
            return NombramientosManager;
        })();
        ts.NombramientosManager = NombramientosManager; //JS	

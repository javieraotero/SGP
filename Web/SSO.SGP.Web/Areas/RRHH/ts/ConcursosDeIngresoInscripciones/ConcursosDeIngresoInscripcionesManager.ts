...
module ConcursosDeIngresoInscripciones.ts {
    ...
    export class ConcursosDeIngresoInscripcionesManager {
        ...
        public editar_dtConcursosDeIngresoInscripciones(el): void {
        ...
        public confirmar_dtConcursosDeIngresoInscripciones(el): void {
            this.ViewIndex.selectRow_ConcursosDeIngresoInscripciones(el);
            var id = this.ViewIndex.getData_ConcursosDeIngresoInscripciones(0);
            this.confirmar("/RRHH/ConcursosDeIngresoInscripciones/Confirmar", { id: id });
        }
        public eliminar_dtConcursosDeIngresoInscripciones(el): void {
            var id = this.ViewIndex.getData_ConcursosDeIngresoInscripciones(0);
        ...
        public setCrear(v: Crear) {
            ...
            v.Guardar.click(function (e) {
                var resultado = new Resultado(); self.ajaxPost(self.ViewCrear, "Resultado", resultado).done(function () { self.ViewIndex.ConcursosDeIngresoInscripciones.fnDraw(); self.ViewCrear.limpiar(); app.irATab(0); });
            });
        ...
        public setEditar(v: Editar) {
            ...
            v.Guardar.click(function (e) {
                var resultado = new Resultado(); self.ajaxPost(self.ViewEditar, "Resultado", resultado).done(function () { self.ViewIndex.ConcursosDeIngresoInscripciones.fnDraw(); self.ViewCrear.limpiar(); app.irATab(0); });
            });
        ...
        public confirmar(url: string, data: any): JQueryDeferred<any> {
            var that = this;
            var df = $.Deferred();

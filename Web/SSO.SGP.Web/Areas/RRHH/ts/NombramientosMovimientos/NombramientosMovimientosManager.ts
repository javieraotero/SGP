...
module NombramientosMovimientos.ts {
	...
	export class NombramientosMovimientosManager {
	
		public ViewIndex: Index;
		public ViewCrear: Crear;
        public ViewEditar: Editar;
        public Nombramientos: Nombramientos.ts.NombramientosManager;
		...
		public editar_dtNombramientosMovimientos():void{ 
		...
		public eliminar_dtNombramientosMovimientos():void{ 
            var id = this.ViewIndex.getData(0);
            var resultado = new Resultado();

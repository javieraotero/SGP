...
module ColaDeMovimientosCESIDA.ts {
	...
	export class Index implements IControlador {
		...
		public ColaDeMovimientosCESIDA:DataTables.DataTable;
		public ColaDeMovimientosCESIDA_Id:number;
		//---  /Propiedades de Formulario --- //
		...
		public setColaDeMovimientosCESIDA(dt: DataTables.DataTable):void {
            var that = this;

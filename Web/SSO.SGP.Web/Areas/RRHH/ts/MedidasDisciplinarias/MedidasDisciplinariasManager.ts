...
module MedidasDisciplinarias.ts {
    ...
    export class MedidasDisciplinariasManager {
            ...
            $.contextMenu({
                ...
                items: {
                    "Bajar": {
                        name: "Bajar",
                        callback: function () {
                            $.when(that.eliminar("RRHH/MedidasDisciplinarias/Eliminar", { id: that.ViewIndex.MedidasDisciplinarias.id }))
                                .done(function () { that.ViewIndex.MedidasDisciplinarias.refrescar() });
                        }
                    },
                    "Editar": {
                        name: "Editar",

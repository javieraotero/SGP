...
(function (PedidosDeSuministros) {
    ...
    (function (ts) {
        var PedidosDeSuministrosManager = (function () {
            function PedidosDeSuministrosManager() {
                // Constructor
            }
            //--- Inicialización de la vista Index
            PedidosDeSuministrosManager.prototype.setIndex = function (v) {
                var that = this;
                this.ViewIndex = v;
                // Eventos de la vista
            };
            ...
            PedidosDeSuministrosManager.prototype.setCrear = function (v) {
                var that = this;
                this.ViewCrear = v;
                ...
                v.Articulo.setCallback(function (ui) {
            ...
            PedidosDeSuministrosManager.prototype.buscarArticulo = function (id, array) {
                return $.grep(array, function (item) {
                    return item.idarticulo == id;
                });
            };

            PedidosDeSuministrosManager.prototype.cambiarCantidad = function (id, entregado, solicitado, array) {
                for (var i in array) {
            ...
            PedidosDeSuministrosManager.prototype.setEditar = function (v) {
                var that = this;
                this.ViewEditar = v;
            ...
            PedidosDeSuministrosManager.prototype.editar_dtPedidosDeSuministros = function () {
            ...
            PedidosDeSuministrosManager.prototype.eliminar_dtPedidosDeSuministros = function () {
                var that = this;
                var id = this.ViewIndex.getData(0);
                var resultado = new Resultado();
            ...
            PedidosDeSuministrosManager.prototype.ajaxPost = function (v, titulo, resultado) {
                var that = this;
                var df = $.Deferred();
                v.form.validate();
                var success = false;
            ...
            PedidosDeSuministrosManager.prototype.ajaxPostURL = function (url, data, titulo, res) {
                var that = this;
                var df = $.Deferred();
                var success = false;
                var retorno = 0;
            ...
            PedidosDeSuministrosManager.prototype.eliminar = function (url, data, resultado) {
                var that = this;
                var df = $.Deferred();
            ...
            return PedidosDeSuministrosManager;
        })();
        ts.PedidosDeSuministrosManager = PedidosDeSuministrosManager;

        var DetalleDePedido = (function () {
            function DetalleDePedido() {
            }
            return DetalleDePedido;
        })();
        ts.DetalleDePedido = DetalleDePedido;

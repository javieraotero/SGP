...
module PartidasPresupuestarias.ts {
	...
	export class Index implements IControlador {
		...
		public PartidasPresupuestarias:DataTables.DataTable;
		public PartidasPresupuestarias_Id:number;
		//---  /Propiedades de Formulario --- //
		...
		public setPartidasPresupuestarias(dt: DataTables.DataTable):void {
            var that = this;

...
module SolicitudesDeViaticosAgentes.ts {
	...
	export class SolicitudesDeViaticosAgentesManager {
		...
		public editar_dtSolicitudesDeViaticosAgentes(el): void {     
		...
		public eliminar_dtSolicitudesDeViaticosAgentes(el): void {
			this.ViewIndex.selectRow_SolicitudesDeViaticosAgentes(el);
            var id = this.ViewIndex.getData_SolicitudesDeViaticosAgentes(0);

...
module SolicitudesDeViaticosRendiciones.ts {
	...
	export class SolicitudesDeViaticosRendicionesManager {
		...
		public editar_dtSolicitudesDeViaticosRendiciones(el): void {     
		...
		public eliminar_dtSolicitudesDeViaticosRendiciones(el): void {
			this.ViewIndex.selectRow_SolicitudesDeViaticosRendiciones(el);
            var id = this.ViewIndex.getData_SolicitudesDeViaticosRendiciones(0);

...
module SolicitudesDeViaticosRendicionesAgentes.ts {
	...
	export class SolicitudesDeViaticosRendicionesAgentesManager {
		...
		public editar_dtSolicitudesDeViaticosRendicionesAgentes(el): void {     
		...
		public eliminar_dtSolicitudesDeViaticosRendicionesAgentes(el): void {
			this.ViewIndex.selectRow_SolicitudesDeViaticosRendicionesAgentes(el);
            var id = this.ViewIndex.getData_SolicitudesDeViaticosRendicionesAgentes(0);

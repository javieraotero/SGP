...
module EjecucionesPresupuestarias.ts {
    ...
    export class EjecucionesPresupuestariasManager {

        public ViewIndex: Index;
        public ViewCrear: Crear;
        public ViewEditar: Editar;
        public ViewCrearAnual: CrearAnual;
        ...
        public setCrearAnual(v: CrearAnual) {
            var that = this;
        ...
        public editar_dtEjecucionesPresupuestarias(): void {
        ...
        public eliminar_dtEjecucionesPresupuestarias(): void {
        ...
        //-- Método para pasar Vistas por Post según URL de formulario
        public crearAnual(titulo: string, resultado?: Resultado): JQueryDeferred {
            var that = this;
            var df = $.Deferred();
            var success = false;
            var retorno: number = 0;

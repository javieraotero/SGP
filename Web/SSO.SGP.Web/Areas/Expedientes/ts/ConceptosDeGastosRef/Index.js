...
(function (ConceptosDeGastosRef) {
    ...
    (function (ts) {
        var Index = /** @class */ (function () {
            ...
            Index.prototype.setConceptosDeGastosRef = function (dt) {
                var self = this;
            ...
            Index.prototype.getData_ConceptosDeGastosRef = function (col) {
                return (this.ConceptosDeGastosRef.fnGetData(this.ConceptosDeGastosRef_index)[col]);
            };
            Index.prototype.selectRow_ConceptosDeGastosRef = function (event) {
                var self = this;
                $(self.ConceptosDeGastosRef.fnSettings().aoData).each(function () {
                    $(this.nTr).removeClass('row_selected');
                });

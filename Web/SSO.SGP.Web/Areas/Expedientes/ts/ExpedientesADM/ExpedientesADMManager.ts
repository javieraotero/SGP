...
module ExpedientesADM.ts {
    ...
    export class ExpedientesADMManager {

        public ViewIndex: Index;
        public ViewIndexSinAsignar: IndexSinAsignar;
        public ViewCrear: Crear;
        public ViewEditar: Crear;
        public ViewDetalle: Detalle;
        public ViewAsignar: Asignar;
        public expediente: Object;
        public ViewIndexConCargo: IndexConCargo;
        public ViewSobreafectar: Sobreafectar;
        public ViewDesafectar: Desafectar;
        ...
        public setDesafectar(v: Desafectar) {
            var that = this;
        ...
        public refrescarPartidasSobreafectar() {
        ...
        public refrescarPartidasDesafectar() {
        ...
        //--- Inicialización de la vista Index
        public setIndexSinAsignar(v: IndexSinAsignar) {
            var that = this;
        ...
        //--- Inicialización de la vista Index
        public setIndexConCargo(v: IndexConCargo) {
            var that = this;
        ...
        public setDetalle(v: Detalle) {
            ...
            $("button[data-tipo=asignar]").live("click", function (e) {
                ...
                app.modal.cargar("Asignar Factura", "/Expedientes/Facturas/Asignar/?factura=" + $(this).data("id") + "&vista=expediente").done(function () {
                    var manager = <Facturas.ts.FacturasManager>app.getManager("Facturas");
            ...
            v.ConfirmarAfectacion.click(function (e) {
                ...
                if (v.operacion == "afectar") {
                    ...
                    if (v.operacion == "compromiso_y_ordenado") {
        ...
        public refreshFacturas(id: number) {
        ...
        public detalle_dtExpedientesADM(): void {
        ...
        public aceptar_dtExpedientesConCargoPendiente(): void {
            var self = this;
        ...
        public detalle_dtExpedientesConCargoPendiente(): void {
            var id = this.ViewIndex.getData(0);
            var numero = this.ViewIndex.getData(2);

        }

        public editar_dtExpedientesADM(): void {
            var id = this.ViewIndex.getData(0);
            var numero = this.ViewIndex.getData(2);
            app.createTab("Editar " + numero, "/Expedientes/ExpedientesADM/Editar/" + id, true, true, true);
        }

        public asignar_dtExpedientesADM(): void {
            var id = this.ViewIndex.getData(0);
            var numero = this.ViewIndex.getData(2);
        ...
        public eliminar_dtExpedientesADM(): void {
            var id = this.ViewIndex.getData(0);
            //this.eliminar("ExpedientesADM/Eliminar", { id: id });
        }


        public guardarSobreAfectacion(titulo: string, resultado?: Resultado): JQueryDeferred {
            var that = this;
            var df = $.Deferred();
            var success = false;
            ...
            var compromiso_y_ordenado: boolean = false;
        ...
        public guardarDesafectacion(titulo: string, resultado?: Resultado): JQueryDeferred {
            var that = this;
            var df = $.Deferred();
            var success = false;
            var retorno: number = 0;
        ...
        public postAfectar(v: IControlador, titulo: string, facturas: Array<number>, resultado?: Resultado): JQueryDeferred {
            var that = this;
            var df = $.Deferred();
            v.form.validate();
            var success = false;
        ...
        public postCompromisoYOrdenadoAPagar(v: IControlador, titulo: string, facturas: Array<number>, resultado?: Resultado): JQueryDeferred {
            var that = this;
            var df = $.Deferred();
            v.form.validate();
            var success = false;
        ...
        public postOrdenadoAPagar(v: IControlador, titulo: string, facturas: Array<number>, resultado?: Resultado): JQueryDeferred {
            var that = this;
            var df = $.Deferred();
            v.form.validate();
            var success = false;
    ...
    export class Facturas {
        ...
        public IdentificacionDeFactura: number;
        public Tipo: number;
        public Expediente: number;
        public Proveedor: number;
        public txtProveedor: string;
        public Fecha: Date;
        public Descripcion: string;
        public Importe: number;
        public Organismo: number;
        public Agente: number;
        public TextoAgente: string;
        public EsFactura: boolean;
        public EstaAsignada: boolean;
        public EstaPagada: boolean;
        public DeImpuestosMunicipales: boolean;
        public Comprobante2: string;
        public Comprobante3: string;
        public DeServicios: boolean;
        public FechaDesde: Date;
        public FechaHasta: Date;
        public Afectada: boolean;
        public Compromiso: boolean;
        public OrdenadoAPagar: boolean;
        public Grupo: number;
        public FechaAlta: Date;
        public FechaBaja: Date;
        public UsuarioAlta: number;
        public UsuarioBaja: number;
        public UsuarioElimina: number;
        public FechaElimina: Date;

    }

    export class ActuacionesView {

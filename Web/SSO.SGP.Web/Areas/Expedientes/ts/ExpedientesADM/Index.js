...
(function (ExpedientesADM) {
    ...
    (function (ts) {
        var Index = /** @class */ (function () {
            ...
            Index.prototype.setExpedientesADMMulti = function (dt, id) {
                var that = this;
                this.ExpedientesADM = dt;
            ...
            Index.prototype.guardarActuacion = function (url, data, res) {
                var that = this;
                var df = $.Deferred();
                var success = false;
                var retorno = 0;
            ...
            Index.prototype.archivarExpediente = function (url, data, res) {
                var that = this;
                var df = $.Deferred();
                var success = false;
                var retorno = 0;

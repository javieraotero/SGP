...
module ActuacionesADM.ts {
    ...
    export class ActuacionesADMManager {
        ...
        public editar_dtActuacionesADM(): void {
        ...
        public eliminar_dtActuacionesADM(): void {
            var id = this.ViewIndex.getData(0);
            var resultado = new Resultado();
        ...
        public actualizarActuacion(v: IControlador, titulo: string, resultado?: Resultado): JQueryDeferred<any> {
            var that = this;
            var df = $.Deferred();
            v.form.validate();
            var success = false;
        ...
        public eliminar(url: string, data: any, resultado: Resultado): JQueryDeferred<any> {
            var that = this;
            var df = $.Deferred();

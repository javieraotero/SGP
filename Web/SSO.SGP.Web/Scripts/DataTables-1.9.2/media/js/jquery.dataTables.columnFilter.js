...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength) {
            ...
            var input = $('<input type="text" class="form-control ' + search_init + sCSSClass + '" value="' + inputvalue + '"/>');
            th.html(input);
            if (bIsNumber)
        ...
        function fnCreateDateRangeInput(oTable) {
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" value="" class="date_range_filter search_init_date" id="' + sFromId + '" rel="' + i + '"/>');
		...
		"Viernes", "Sábado"],
            ...
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="date_range_filter search_init_date" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
            th.wrapInner('<span class="filterColumn filter_date_range" />');


            to.datepicker(pickerOpts);
            var index = i;
            aiCustomSearch_Indexes.push(i);
